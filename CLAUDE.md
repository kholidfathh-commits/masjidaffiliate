...
- Jalankan uji yang relevan: `node uji-keuangan-aset.mjs` (62 tes), `node uji-absensi.mjs` (80), `node uji-lms.mjs` (79), `node uji-akses.mjs` (25). Project ini JS murni — TIDAK ada typecheck/ESLint.
